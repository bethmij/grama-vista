...
public class LandManageBOImpl implements LandManageBO {
    ...
    public List<CoOwnerDTO> searchAllOwners() throws SQLException {
        List<CoOwner> coOwnerLists = coOwnerDAO.searchAllOwner();
    ...
    public LandDTO searchLand(String id) throws SQLException {
    ...
    public boolean deleteLand(String id) throws SQLException {
